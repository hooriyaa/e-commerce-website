  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="space-y-4 mt-12">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight ">{product.name}</h1>
        ...
        <p className="text-gray-600 text-base sm:text-lg">{product.description} Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iusto nesciunt cupiditate ratione aperiam minus! Voluptate quae nihil ea</p>
