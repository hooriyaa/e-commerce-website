  ...
  return (
    <main className="min-h-screen mt-4 sm:w-full  w-[700px] ml-24 sm:ml-0 font-[Inter]">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 md:p-12 bg-white">
        <div className="bg-[#007580] text-white p-8 md:p-12 rounded-lg flex flex-col justify-center">
          ...
          <p className="text-base mb-6 text-[#FFFFFF]">
            ...
            space and elevate your comfort. Specializing in contemporary
            furniture design with a focus on modern aesthetics, we craft chairs
      ...
      <section className="py-16 px-6 md:px-12 bg-gray-50">
        <h2 className="text-2xl md:text-3xl font-semibold mb-12 text-[#272343]">
...
function FeatureCard({
  ...
  return (
    <div className="p-6 bg-[#F9F9F9] rounded-lg shadow-sm  transition-all duration-300 ease-in-out hover:bg-[#e4e4e4] hover:scale-105">
      ...
      <h3 className="text-lg font-normal mb-2 text-[#007580] font-[Inter] ">
        {title}
      </h3>
      <p className="text-[#007580] text-sm font-[Inter] font-normal">
        {description}
      </p>
    </div>
  );
