...
const FeaturesProducts = () => {
  return (
    <section className="text-gray-600  relative left-64 sm:left-0 sm:ml-0">
      <h1 className=" text-base md:text-xl lg:text-2xl font-semibold font-[inter] text-center  p-6">
        Featured Products
      </h1>
